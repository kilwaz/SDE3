...
import application.testing.TestingUtils;
...
/**
 * JUnit test class for {@link application.node.implementations.BashNode}.
 *
 * @author Alex Brown
 */
...
public class BashNodeTest {
     ...
     * The expected result would be receive a {@link application.node.objects.Bash} Object but with an empty string script content.
     *
     * @throws Exception
     */
    @Test
     ...
     * The expected result would be for the returned {@link application.node.objects.Bash} Object to have the same script as what we passed in
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Copy the BashNode
     * Here we are testing copying a {@link application.node.implementations.BashNode} node, it should duplicate all values that can be passed to it
     ...
     * <p>
     * The copy method is held in {@link application.node.design.DrawableNode}.
     *
     * @throws Exception
     */
    @Test
     ...
     *
     * @param node1 First {@link application.node.implementations.BashNode} to compare.
     * @param node2 Second {@link application.node.implementations.BashNode} to compare.
     */
