...
import sde.application.gui.columns.testsetbatchwindow.statecompare.CompareStateElementObject;
import sde.application.test.action.helpers.PageStateCapture;
import sde.application.test.annotation.AssertChange;
import sde.application.test.core.AssertData;
