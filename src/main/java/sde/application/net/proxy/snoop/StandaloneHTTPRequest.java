...
import sde.application.net.proxy.BasicAuthUsernamePassword;
 ...
 * <p>
 * A {@link WebProxyRequestManager} must be set to manage the request.
 * <p>
 * <pre>
 * {@code
...
public class StandaloneHTTPRequest {
     ...
     * @return Returns the instance of the {@link StandaloneHTTPRequest}
     */
    ...
    /**
     * Sets a {@link WebProxyRequestManager} to manage this request.
     *
    ...
    private StandaloneHTTPRequest executeHttp() {
        ...
        try {
            ...
            if ("POST".equals(method) || "PUT".equals(method)) {
                requestSize += connection.setRequestProperty("Content-Type", "sde/application/x-www-form-urlencoded");
            ...
            if (basicAuthUsernamePassword != null) {
                ...
                ByteBuf authChannelBuffer = Unpooled.copiedBuffer(authString, Charset.forName("UTF-8"));
                ByteBuf encodedAuthChannelBuffer = Base64.encode(authChannelBuffer, false);
                requestHeaders.put("Authorization", "Basic " + encodedAuthChannelBuffer.toString(Charset.forName("UTF-8")));
            }
