...
public class TestingUtils {
    ...
    /**
     * @return Returns the created {@link Program}.
     */
     ...
     *
     * @param testProgram The {@link Program} that this node should be added to.  Typically a test only program.
     * @param testClass   A {@link java.lang.Class} reference to the node implementation we want to create.
     * @return Returns the created {@link DrawableNode}.
     */
