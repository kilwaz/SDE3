...
import sde.application.data.model.dao.SwitchDAO;
import sde.application.gui.Controller;
import sde.application.gui.GUIUpdate;
import sde.application.gui.Program;
import sde.application.gui.update.switchnode.AddSwitchRow;
import sde.application.gui.update.switchnode.RemoveSwitchRow;
import sde.application.gui.update.switchnode.ToggleButtonImage;
import sde.application.node.design.DrawableNode;
import sde.application.node.objects.Switch;
import sde.application.node.objects.comparators.SwitchTargetComparator;
