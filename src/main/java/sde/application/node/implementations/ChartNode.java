...
import sde.application.data.chart.Chart;
import sde.application.data.chart.ChartPoint;
import sde.application.data.chart.ChartSeries;
...
public class ChartNode extends DrawableNode {
    ...
    /**
     * This method is used to copy a {@link ChartNode} and give back a new object.
     *
     * @param chartNode The {@link ChartNode} we want to create a copy of.
     */
