...
import sde.application.gui.canvas.DrawablePoint;
...
public class DrawableNode extends DatabaseObject {
        ...
        try {
            ...
            if (src != null) {
                ...
                while (true) {
                    ...
                    if (name.startsWith("sde/application/node/implementation") && name.contains("Node.class")) {
    ...
    public void save() {
        super.save();
        getDataToSave().forEach(SavableAttribute::save);
    }
    ...
    public void delete() {
        ...
        savableAttributes.forEach(SavableAttribute::delete);
        super.delete();
    }
     ...
     *
     * @param <Node> Generic node which extends {@link DrawableNode}.
